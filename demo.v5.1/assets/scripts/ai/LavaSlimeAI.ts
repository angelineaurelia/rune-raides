...
export default class LavaSlimeAI extends cc.Component {
    ...
    update(dt: number) {
        ...
        // If attacking, do nothing until sequence completes
        ...
        if (this.slimeState === SlimeState.Walk) {
            ...
            const moveDelta = cc.v2(this.direction.x * this.walkSpeed * dt, this.direction.y * this.walkSpeed * dt);
    ...
    private drawHealthBar() {
        ...
        let fillColor = cc.color(255, 50, 0);
        if (filled <= 3) fillColor = cc.color(100, 0, 0);
    ...
    private startAttack() {
        ...
        // play idle or wind-up
        this.anim.play("LavaSlimeIdle");
        // queue actual attack after delay
        this.scheduleOnce(() => this.performAttack(), this.timeBeforeAttack);
    }

    private performAttack() {
        // perform animation and damage
        ...
        // return to idle after the attack animation (1s)
    ...
    /**
     * Applies attack damage to the player.
     */
